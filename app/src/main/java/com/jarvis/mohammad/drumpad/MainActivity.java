package com.jarvis.mohammad.drumpad;
...
public class MainActivity extends AppCompatActivity {
    ...
    int sound0, sound1,sound2,sound3,sound4,sound5,sound6,sound7,sound8,sound9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sound4=sp.load(getApplicationContext(),R.raw.sound12,1);
        ...
        sound9=sp.load(getApplicationContext(),R.raw.sound11,1);
        sound0=sp.load(getApplicationContext(),R.raw.sound00,1);
    }

    public void playsound1(View view) {
        sp.play(sound1,1.0f,1.0f,0,0,5f);
    }
    public void playsound2(View view) {
        sp.play(sound2,1.0f,1.0f,0,0,5f);
    }
    public void playsound3(View view) {
        sp.play(sound3,1.0f,1.0f,0,0,5f);
    }
